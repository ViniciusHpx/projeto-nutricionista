...
#Como eu utilizei o atuh que já é do django um metodo para autenticação
#Eu preciso importa-lo aqui pois é la onde estar meu usuário cadastrado
#pois utilizamos aqui no projeto um chave estrangeira que aponta para esse usuário
...
class Pacientes(models.Model):
    ...
    #Aqui eu estou dizendo que so pode as duas opções acima
