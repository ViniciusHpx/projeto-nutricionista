...
from . utils import password_is_valid, nama_is_valid,email_is_valid,email_html
...
def cadastro(request):
    if request.method == "GET":
        ...
        if not nama_is_valid(request, usuario):
        ...
        try:
            ...
            #Mensagem pro usuário na tela de cadastro realizado com sucesso
